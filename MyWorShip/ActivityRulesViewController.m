...
- (void)viewDidLoad {
    ...
    "3 注意事项\n"
    "(1)每位用户的邀请次数无上限;\n"
    "(2)受邀者需从未注册过 奇拜，每位新用户只能被邀请一次;\n"
    "(3)邀请关系以受邀者第一次提交注册手机号信息为准，\n"
    "(4)拥有相同账户、手机号及设备的用户视为同一用户，该规则适用于邀请者与被邀请者;\n"
    "(5)通过此次活动获得的张优惠劵可直接在支付中优惠价格；\n"
    "\n"
    "4 特别声明\n"
    "我们包含邀请注册在内的所有优惠推广活动仅向正当、合法使用我们服务/奇拜的用户。每位参与者(含邀请 人及被邀请人)的 奇拜帐号、手机号及其他身份信息必须是唯一的，任何信息与其他用户重合都不能参加 该活动。活动中，一旦发现您存在利用我们的规则漏洞进行任何形式的作弊行为(包括但不限于通过我们的活动获得不正当的经济利益)，我们有权取消与作弊行为相关账户的奖励、追回您作弊所得的不正当经济利益、关闭作弊账户或与您相关的所有账户，并保留取消您后续使用我们服务/奇拜的权利，必要时会依据严重程度 追究您的法律责任。";
